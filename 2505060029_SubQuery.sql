...
CREATE TABLE `ambil_mk` (
  ...
  KEY `nim` (`nim`),
  KEY `kode_mk` (`kode_mk`),
  CONSTRAINT `ambil_mk_ibfk_1` FOREIGN KEY (`nim`) REFERENCES `mahasiswa` (`nim`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `dosen` VALUES (10,'Suharto','Jl. Jombang'),(11,'Martono','Jl. Kalpataru'),(12,'Rahmawati','Jl. Jakarta'),(13,'Bambang','Jl. Bandung'),(14,'Nurul','Jl. Raya Tidar'),(23,'Dosen Sipil','Jl. Sipil'),(33,'Dosen Jaringan','Jl. Jaringan'),(99,'Dosen SI','Jl. SI');
...
INSERT INTO `matakuliah` VALUES ('PTI123','Grafika Multimedia',3,5,12),('PTI333','Basis DataTerdistribusi',3,5,10),('PTI447','Praktikum Basis Data',1,3,11),('PTI777','Sistem Informasi',2,3,99),('TIK123','Jaringan Komputer',2,5,33),('TIK333','Sistem Operasi',3,5,10),('TIK342','Praktikum Basis Data',1,3,11);
...
-- Dump completed on 2026-05-12  8:51:29
